					...
					<div class="section-body">
								...
								<div class="card">
									<div class="card-body no-padding">
										<div class="alert alert-callout alert-info no-margin">
											...
											<span class="opacity-50"> Rekap Booking Kursi Bulan Sebelumnya</span>
								...
								<div class="card">
									<div class="card-body no-padding">
										<div class="alert alert-callout alert-warning no-margin">
											...
											<span class="opacity-50">Rekap Booking Kursi Bulan Ini</span>
								...
								<div class="card">
									<div class="card-body no-padding">
										<div class="alert alert-callout alert-info no-margin">
											<strong class="pull-right text-success text-lg"> <i class="fa fa-bar-chart"></i></strong>
											<strong class="text-xl"><?php echo 'Rp '.number_format($total_penjualanlst);?></strong><br/>
											<span class="opacity-50">Rekap Pengiriman Paket Bulan Sebelumnya</span>
											<div class="stick-bottom-left-right">
												<div class="height-2 sparkline-revenue" data-line-color="#bdc1c1"></div>
											</div>
										</div>
								...
								<div class="card">
									<div class="card-body no-padding">
										<div class="alert alert-callout alert-warning no-margin">
											<strong class="pull-right text-warning text-lg"> <i class="fa fa-line-chart"></i></strong>
											<strong class="text-xl"><?php echo 'Rp '.number_format($total_penjualannw);?></strong><br/>
											<span class="opacity-50">Rekap Pengiriman Paket Bulan Ini</span>
											<div class="stick-bottom-right">
												<div class="height-1 sparkline-visits" data-bar-color="#e5e6e6"></div>
											</div>
										</div>
								...
								<div class="card">
									<div class="card-body no-padding">
										<div class="alert alert-callout alert-danger no-margin">
											...
											<span class="opacity-50">Rekap Total Dari Bulan Awal Sampai Bulan Ini</span>
											<div class="stick-bottom-right">
												<div class="height-1 sparkline-visits" data-bar-color="#e5e6e6"></div>
											</div>
										</div>
						...
						<div class="row">
						    ...
						    foreach($this->statistik_booking as $result){
						    	if ($result['tanggal']==NULL && $result['total']==NULL) {
						    		$bulan[] = ""; //ambil bulan
						        	$value[] = ""; //ambil nilai
						    	}else {
						...
						?>
						    ...
						    foreach($this->statistik_paket as $rs){
						    	if ($rs['tanggal']==NULL && $rs['total']==NULL ) {
						    		 $bulan_paket[] = ""; //ambil bulan
						        	 $value_paket[] = ""; //ambil nilai
						    	}else{
