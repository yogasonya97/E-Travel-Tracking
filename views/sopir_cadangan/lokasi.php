...
<form method="POST" action="<?php echo URL;?>sopircd/set_lokasi">
 <table class="table table-hover" id="datatable1">
    <tr>
        <td>Plat.Mobil :</td><td><?php echo $no_mobil_cadangan;?><input type="hidden" name="busNo" value="<?php echo $mobil;?>"></td>
    </tr>
    <tr>
