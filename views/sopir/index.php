...
<!-- <script src='https://production-assets.codepen.io/assets/editor/live/console_runner-079c09a0e3b9ff743e39ee2d5637b9216b3545af0de366d4b9aad9dc87e26bfd.js'></script>
  <script src='https://production-assets.codepen.io/assets/editor/live/events_runner-73716630c22bbc8cff4bd0f07b135f00a0bdc5d14629260c3ec49e5606f98fdd.js'></script><script src='//production-assets.codepen.io/assets/editor/live/css_live_reload_init-2c0dc5167d60a5af3ee189d570b1835129687ea2a61bee3513dee3a50c115a77.js'></script><meta charset='UTF-8'><meta name="robots" content="noindex"><link rel="shortcut icon" type="image/x-icon" href="https://production-assets.codepen.io/assets/favicon/favicon-8ea04875e70c4b0bb41da869e81236e54394d63638a1ef12fa558a4a835f1164.ico" /><link rel="mask-icon" type="" href="//production-assets.codepen.io/assets/favicon/logo-pin-f2d2b6d2c61838f7e76325261b7195c27224080bc099486ddd6dccb469b8e8e6.svg" color="#111" /><link rel="canonical" href="https://codepen.io/romswellparian/pen/eNJvNB?depth=everything&order=popularity&page=64&q=Overlay&show_forks=false" />
...
.footer a span {
  ...
  <div class="box header">
    <img src="<?php echo URL;?>assets/sopir/images/img_mobil/<?php echo $foto_lama;?>" alt="" />
    <h2><?php echo $name;?></h2>
    <h4>No.Plat Mobil :</h4>
    <h3><strong><?php echo $no_mobil;?></strong></br><?php echo $merek;?></h3>
  ...
  <form action="<?php echo URL; ?>sopir/set_tglposisi" method="POST">
...
<input type="text" name="tgl_posisi" value="<?php echo $a;?> " disabled>
    ...
    <?php               $c=0;
                        ...
                        <form action="<?php echo URL; ?>sopir/set_istirahat" method="post">
                        ...
                        <span class="fa fa-car"></span><input type="submit" class="btns" value="Istirahat">
                       </form> 
                        ...
                        <form action="<?php echo URL; ?>sopir/set_berangkat" method="post">
                          <input type="hidden" name="tgl_posisi" value="<?php echo $a;?>">
                        ...
                        <input type="submit" class="btns" value="Berangkat">
                       </form> 
   ...
   <?php               if ($this->jurusan_lampung == NULL){
                        ...
                        <form action="<?php echo URL; ?>sopir/set_lampung" method="post">
                          <input type="hidden" name="tgl_posisi" value="<?php echo $a;?>">
                        <input type="hidden" name="busNo<?php echo $c;?>" value="<?php echo $busNo;?>">
                        <input type="hidden" name="journeyNo<?php echo $c;?>" value="<?php echo $journeyNo;?>">
                       ...
                       <?php $c++;}} ?>
                        <input type="submit" class="btns" value="Di Lampung">
                       </form> 
        ...
        <?php             if ($this->jurusan_palembang == NULL){
                        ...
                        <form action="<?php echo URL; ?>sopir/set_palembang" method="post">
                          <input type="hidden" name="tgl_posisi" value="<?php echo $a;?>">
                        <input type="hidden" name="busNo<?php echo $c;?>" value="<?php echo $busNo;?>">
                        <input type="hidden" name="journeyNo<?php echo $c;?>" value="<?php echo $journeyNo;?>">
                        <input type="hidden" name="journeyFrom<?php echo $c;?>" value="<?php echo $journeyFrom;?>">
                        ...
                        <input type="hidden" name="journeyNo1<?php echo $c;?>" value="<?php echo $journeyNo1;?>">
                         <input type="hidden" name="journeyFrom1<?php echo $c;?>" value="<?php echo $journeyFrom1;?>">
                       <?php $c++;}} ?>
                        <input type="submit" class="btns" value="Di Palembang">
                       </form> 
