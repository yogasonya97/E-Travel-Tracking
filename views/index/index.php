...
<script type="text/javascript">
  ...
  if (nama_wilayah=="Palembang")
    {
        document.getElementById("tampil_tujuan").innerHTML="<div class='choose-car-type book-item'><h4>Jurusan Ke :</h4> <select class='custom-select' name='journeyTo' id='journeyTo' data-validation='required'><option selected>Pilih Tujuan</option><option value='BBM'>MENGGALA-BANDAR JAYA-BANDAR LAMPUNG</option><option value='MPP'>PRINGSEWU-PEKALONGAN-METRO</option><option value='SK'>KOTA GAJAH-SUKADANA</option></select></div>"
    }
  else if (nama_wilayah=="Lampung")
    {
        document.getElementById("tampil_tujuan").innerHTML="<div class='choose-car-type book-item'><h4>Jurusan Ke :</h4> <select class='custom-select' name='journeyTo' id='journeyTo' data-validation='required'><option selected>Pilih Tujuan</option><option value='KP'>KAYUAGUNG-PALEMBANG</option></select></div>";
    }
}
</script>
    <!--[if lt IE 9]>
                            ...
                            <form id="search_buses_form" action="<?php echo URL; ?>booker/" method="post">
                               ...
                               <!--  <div class="pick-up-date book-item">
                                ...
                                <div class="book-button text-center">
                                    <input class="book-now-btn" type="submit" name="searchBuses" id="searchBuses" value="Cari Mobil">
                        ...
                        <div class="display-table">
                            <div class="display-table-cell">
                                <div class="slider-right-text">
                                    <center><h1>BOOKING KURSI SEKARANG!</h1>
                                    <p>SILAHKAN BOOKING <br> DENGAN TUJUAN YANG ANDA INGINKAN</p>
                                    <p>Berangkat Setiap Hari <br> Setiap Jam 18:00 WIB</p></center>
                                </div>
                            </div>
                        </div>
                    </div>
