...
<html lang="en">
	<head>
		<title>Orders Booking Kursi</title>
	...
	<body class="menubar-hoverable header-fixed ">
			...
			<div id="content">
				<section>
					<div class="section-header">
							<h2><span class="fa fa-cart-arrow-down"></span> Data Order Booking Kursi</h2>
					</div>
					...
					<div class="section-body">	
						...
						<?php 
									...
									foreach ($this->list_order as $x) {
										$no_booking=$x['bookingID'];
										$tgl=$x['tgl'];
										$tgl_booking=$x['tgl_booking'];
										$plg=$x['bookerName'];
			...
			<?php 
									...
									foreach ($this->list_order as $x) {
										...
										if ($ke == "KP") {
											...
											$tujuan = "MENGGALA-BANDAR JAYA-BANDAR LAMPUNG";
										}else if($ke == "MPP"){
											$tujuan = "PRINGSEWU-PEKALONGAN-METRO";
										}else if ($ke == "SK") {
											$tujuan = "KOTA GAJAH-SUKADANA";
										}	
									...
									<div class="form-group">
										<div class="col-sm-12">
											<table>
												...
												<tr>
													<td style="width:120px;">Untuk Tanggal</td>
													<td>:</td>
													<td><?php echo $tgl_booking; ?></td>
												</tr>
												<tr>
		...
		<?php } ?>
			...
			<div class="modal fade" id="modal_edit_pengguna<?php echo $no_booking;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
			    ...
			    <form class="form-horizontal" role="form" method="post" action="<?php echo URL;?>admin/update_statusorder" enctype="multipart/form-data">
			        <div class="modal-body">
									<div class="form-group">
			...
			<div class="modal fade" id="modal_hapus_pengguna<?php echo $no_booking; ?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
			    ...
			    <form class="form-horizontal" role="form" method="post" action="<?php echo URL; ?>admin/hapus_order" enctype="multipart/form-data">
			        <div class="modal-body">
									<div class="form-group">
