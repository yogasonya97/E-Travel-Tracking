	...
	<body class="menubar-hoverable header-fixed ">
			...
			<div id="content">
				<section>
					<div class="section-header">
							<h2><span class="fa fa-exchange"></span> Data Konfirmasi Booking Kursi</h2>
					</div>
					...
					<div class="section-body">	
						<div class="row">
							...
							<?php 
								...
								foreach ($this->list_konfirmasi1 as $a) {
									$id=$a['konfirmasi_id'];
								...
								<tr>
									...
									<td><a href="<?php echo URL;?>admin/order_detail/<?php echo $invoice;?>"><?php echo $invoice;?></a></td>
									<td><?php echo $nama;?></td>
									<td><?php echo $bank;?></td>
		...
		<!-- END BASE -->
			...
			<div class="modal fade" id="modal_edit_pengguna<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
			    ...
			    <form class="form-horizontal" role="form" method="post" action="<?php echo URL; ?>admin/update_konfirmasi" enctype="multipart/form-data">
			...
			<div class="modal fade" id="modal_hapus_pengguna<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
			    ...
			    <form class="form-horizontal" role="form" method="post" action="<?php echo URL;?>admin/batal_konfirmasi" enctype="multipart/form-data">
			        <div class="modal-body">
