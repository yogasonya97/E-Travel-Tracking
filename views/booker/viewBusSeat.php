 <?php
    ...
    ?>
<center><pre><h4><b>Depan Mobil</b></h4></pre></center>
<div id="area">
...
//                    exit();
                ...
                if ($noOfSeat == 40) {
                    for ($i = 0; $i < $cols; $i++) {
                        for ($j = 0; $j < $rows; $j++) {
                            $p = ($i * $rows + $j + 0);
                            if ($p == 3 || $p == 7 || $p == 13 || $p == 18 || $p == 23 || $p == 28 || $p == 33 || $p == 38 || $p == 43 || $p == 48 || $p == 53 || $p == 58 || $p == 4 || $p == 5 || $p == 39 || $p == 40) {
                                $seatNo = null;
                    ...
                    for ($i = 0; $i < $cols2; $i++) {
                        for ($j = 0; $j < $rows2; $j++) {
                            $p = ($i * $rows2 + $j + 1);
                            if ($p == 4 || $p == 4 || $p == 7 || $p == 12 || $p == 18 || $p == 23 || $p == 28 || $p == 33 || $p == 38 || $p == 43) {
                                $seatNo = null;
                                $className = $seatCss . ' ' . $hidingSeatCss . ' ' . $rowCssPrefix . $i . ' ' . $colCssPrefix . $j;
                            } else {
                                $seatNo = (++$x); //bookSeat=[5,8,9];
