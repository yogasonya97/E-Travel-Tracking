	...
	<body class="o-page">
		<div id="page">
			...
			<div id="content">
				...
				<a href="<?php echo URL; ?>paket/paymentConform_cod/<?php echo $this->no_resi; ?>" class="o-buttons blue" style="border:none;height:37px;width:100%;text-align:center;"><span class="fa fa-gift"></span> Bayar di Tempat</a>
				<a href="<?php echo URL; ?>paket/transfer_bank/<?php echo $this->no_resi; ?>" class="o-buttons red" style="border:none;height:37px;width:100%;text-align:center;"><span class="fa fa-exchange"></span> Transfer Bank</a>
