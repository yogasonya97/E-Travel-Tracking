$(function(){
    ...
    //alert(host+'/e-travel/booker/onlineBooker/');
    //if(host+'/e-travel/booker/onlineBooker/'==window.location)
    //window.location.replace("http://localhost/e-travel/index")
    ...
    function sessionforSelectin_s() {
        $.ajax({
            type:'POST',
            url:'/e-travel/booker/xhrgetSessionforSelectin_s',
            data:{
            },
            dataType:'json',
        ...
        $.ajax({
            type:'POST',
            url:'/e-travel/booker/xhrgetSessionforSelectin_s_tot',
            data:{
            },
            dataType:'json',
            beforeSend:function(o){
    ...
    function sessionTimeOut() {
        ...
        $.ajax({
            type:'POST',
            url:'/e-travel/booker/xhrSessionTimeOut',
            dataType:'json',
            beforeSend:function(o){
            },
            success:function(o){
    ...
    function setIncrementSessionforSelectin_s(seatNo) {
        ...
        $.ajax({
            type:'POST',
            url:'/e-travel/booker/xhrIncrementSessionforSelectin_s',
            data:{
                seatNo:seatNo,
                tot_price:tot_price
            },
    ...
    function setSubtractionSessionforSelectin_s(seatNo) {
        ...
        $.ajax({
            type:'POST',
            url:'/e-travel/booker/xhrSubtractionSessionforSelectin_s',
            data:{
                seatNo:seatNo,
                tot_price:tot_price
            },
    ...
    function insertSeattoTable(seatNo) {
        ...
        $.ajax({
            type:'POST',
            url:'/e-travel/booker/xhrInsertBookingSeat',
            data:{
                seatNo:seatNo,
                busNo:busNo,
                journeyNo:journeyNo,
    ...
    function afterInsertSeat(seatNo) {
        ...
        $.ajax({
            type:'POST',
            url:'/e-travel/booker/viewBusSeat',
            data:{
                busNo:busNo,
                noOfSeat:noOfSeat,
                journeyNo:journeyNo,
    ...
    function setSessionforTime() {
        $.ajax({
            type:'POST',
            url:'/e-travel/booker/xhrsetSession',
            beforeSend:function(o){
            },
            success:function(o){
                sessionTimeOut();
    ...
    function clearAllSeateformDB(allSeatNo) {
        ...
        $.ajax({
            type:'POST',
            url:'/e-travel/booker/xhrClearAllSeate',
            data:{
                seatNo:seatNo,
                busNo:busNo,
                journeyNo:journeyNo,
