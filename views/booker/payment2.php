...
<?php
echo '<div class="printBookinName"><h3>Booking Tikect</h3></div></br></br></br></br>';
echo '<link href="http://localhost/e-travel/public/css/booker/ticket.css" rel="stylesheet"></link>';
...
<form id="" action="http://localhost/E-Wallet_files/E-Wallet.php" method="post">
    ...
    <div class="payment">
                ...
                <a href="" class="o-buttons blue" style="border:none;height:37px;width:100%;text-align:center;"><span class="fa fa-gift"></span> Bayar di Tempat</a>
                <a href="" class="o-buttons red" style="border:none;height:37px;width:100%;text-align:center;"><span class="fa fa-exchange"></span> Transfer Bank</a>
