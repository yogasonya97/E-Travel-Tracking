...
<html>
  ...
  <link rel="apple-touch-icon-precomposed"
		...
		<title>E-Travel History Booking</title>
				...
				<article>
					...
					<div class="prod-single-content">
						...
						<table style="width:100%;border:none;padding:0px;">
							...
							<tbody>
							<?php foreach ($this->history_order as $a) {
								$invoice=$a['bookingID'];
								$tanggal=$a['date'];
							...
							?>
								<tr>
									...
									<?php if ($status==NULL) {?>
											<td><a href="<?php echo URL;?>booker/cetak_invoice/<?php echo $invoice;?>"></a></td>
									<td style="text-align:center;"></td>
									<td style="text-align:center;"></td>
									<?php }else{ ?>
										<td><a href="<?php echo URL;?>booker/cetak_invoice/<?php echo $invoice;?>"><?php echo $invoice;?></a></td>
